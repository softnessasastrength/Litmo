...
## North star addition (2026-07-14) — younger me

The purpose above is still true and still primary. This adds to it; it does not replace it.

> It is no longer just for me. It must also serve as a guided path for **"earlier me"** — that scared, younger version of myself (or anyone like me) who is convinced they are too much, terrified of ruining good relationships, and has no map for how to show up safely.

**Mission:** turn Litmo into a compassionate, step-by-step companion that walks a terrified, emotionally overwhelmed person through the entire process of feeling safe enough to show up fully in a relationship — without requiring them to do a shitload of therapy first.

**Voice for this layer:** a wise, slightly unhinged older brother who's been through the exact same shit — not a therapist. Every protocol should feel like armor, not homework.
...
- I Need You But I'm Scared You'll Leave (dual-bind ritual)  
...
- Since 2026-07-14, also a **guided path for "younger me"** — see "North star addition" above; not a pivot away from the above, an addition to it  
...
4. **The younger-me guided path** (2026-07-14 addition) — explicitly requested, not default behavior; still bound by 1–3  
5. **Product residue** — only if I explicitly ask, beyond the younger-me path above  
...
7. The younger-me guided path ("North star addition," 2026-07-14) is real and explicitly requested — build toward it when asked, in the older-brother voice, without turning it into market theater.
...
Third stamp (2026-07-14):

> **Also a map for younger me — armor, not homework.**

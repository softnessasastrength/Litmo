...
- **Resolved 2026-07-12** (`docs/adr/0015`–`0019`, `0023`, `0024`): session requests create/accept/decline/cancel with 24h request + pre-activation expiry; Realtime + local alert; **one-way blocks** hide discovery and reject requests opaquely, cancelling pending requests. Not implemented: remote OS push while backgrounded; structured reports / moderator queue; auto-end of active sessions on block. Removal criterion: reviewed push + Chapter 5 report/moderation slices.

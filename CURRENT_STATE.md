...
- Done recently: **Containment Hub** (`/containment`) + Conflict Sim, Cathedral, Morning Cuddle, Spooning.
- Follow `docs/REAL_PURPOSE.md`. Next silly-useful: Interest Reverse Engineering, “I’m Not Ready To Get Up Yet.”
